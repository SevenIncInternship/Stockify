...
use App\Http\Controllers\ManajerExportController; // Pastikan ini diimpor
...
Route::middleware(['auth'])->group(function () {
    ...
    Route::middleware('role:admin')
        ...
        ->group(function () {
            ...
            // Rute untuk menghasilkan SKU yang hilang
            ...
            Route::resource('/barang_masuk', BarangMasukController::class)->names([
                ...
                // 'konfirmasi' => 'barang_masuk.konfirmasi', // Ini mungkin lebih cocok di Staff
            ]);
            ...
            // Rute Laporan (khusus Admin) - Dikelompokkan di sini
            Route::prefix('laporan')->name('laporan.')->group(function () {
                Route::get('/barang_masuk/pdf', [LaporanController::class, 'barangMasukPDF'])->name('barangMasuk.pdf');
                Route::get('/barang_keluar/pdf', [LaporanController::class, 'barangKeluarPDF'])->name('barangKeluar.pdf'); // Ditambahkan
                Route::get('/stok/pdf', [LaporanController::class, 'stokPDF'])->name('stok.pdf'); // Ditambahkan
                Route::get('/aktivitas_pengguna/pdf', [LaporanController::class, 'aktivitasPenggunaPDF'])->name('aktivitasPengguna.pdf'); // Ditambahkan

                Route::get('/stok', [LaporanController::class, 'stok'])->name('stok');
                Route::get('/barang_masuk', [LaporanController::class, 'barangMasuk'])->name('barangMasuk');
                Route::get('/barang_keluar', [LaporanController::class, 'barangKeluar'])->name('barangKeluar');
                Route::get('/aktivitas_pengguna', [LaporanController::class, 'aktivitasPengguna'])->name('aktivitasPengguna');
            });
        });
    ...
    Route::middleware('role:manajer')
        ...
        ->group(function () {
            ...
            // Rute Laporan (khusus Manajer) - Dikelompokkan di sini
            Route::prefix('laporan')->name('laporan.')->group(function () {
                Route::get('/stok', [LaporanController::class, 'stok'])->name('stok');
                Route::get('/barang_masuk', [LaporanController::class, 'barangMasuk'])->name('barangMasuk');
                Route::get('/barang_keluar', [LaporanController::class, 'barangKeluar'])->name('barangKeluar');
